...
• **Documentation:** Take thorough notes and record important observations during the interview.`
  ...
  const validateSignupForm = () => {
    ...
    // Surname validation
    if (!signupFormData.surname.trim()) {
      ...
      <div className="bg-black min-h-screen flex items-center justify-center relative">
        ...
        {showSuccessMessage && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-green-600 text-white p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-green-100">Welcome to DocHuman. Redirecting you to get started...</p>
            </div>
          </div>
        )}
        ...
        <div className="bg-[#2A2A2A] rounded-2xl p-8 w-full max-w-md mx-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Join DocHuman and transform your documents</p>
          </div>
          ...
          <form onSubmit={handleSignupFormSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleSignupInputChange('surname', e.target.value)}
                className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors ${
              ...
              />
              {signupFormErrors.surname && (
                <p className="mt-1 text-sm text-red-400">{signupFormErrors.surname}</p>
              )}
            </div>
