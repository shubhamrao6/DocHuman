            ...
            <>
              ...
              <form onSubmit={handleEmailFormSubmit} className="space-y-4">
                <div>
                  ...
                  />
                  {emailFormErrors.firstName && (
                    <p className="mt-1 text-sm text-red-400">{emailFormErrors.firstName}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {emailFormErrors.surname && (
                    <p className="mt-1 text-sm text-red-400">{emailFormErrors.surname}</p>
                  )}
                </div>
