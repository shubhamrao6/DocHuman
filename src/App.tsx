      ...
      <div className="bg-black text-white font-sans min-h-screen flex">
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <div className="w-full mt-8 px-4 sm:px-10">
            <form onSubmit={handleQuerySubmit} className="w-full max-w-2xl mx-auto relative mb-6">
              <input 
                type="text" 
                value={query}
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <main className="flex-grow flex flex-col items-center justify-center -mt-10">
          <div className="w-full max-w-2xl flex flex-col items-center text-center">
            <h1 className="text-4xl font-normal text-white mb-3">Generate from prompt</h1>
